...
async def ingest() -> IngestResponse:
    ...
    Returns:
        IngestResponse: JSON object with status and count of ingested items
    ...
    try:
        ...
        ingested_count = ingest_all_sources()
        logger.info(f"Ingestion completed successfully. Ingested {ingested_count} items.")
        return IngestResponse(status="ok", ingested=ingested_count)
